...
class Program:
    ...
    def __init__(self):
        ...
        self.start_section_instructions = []
        self.main_section_instructions = []

    def setStartInstruction(self, program_line):         
         instruction = Instruction()
         instruction.setProgram_line(program_line)
         
        #  instruction = {'section': 'start',
        #                 'address': 0,
        #                 'instruction_in_hex': 0,
        #                 'instruction_in_binary': 0,
        #                 'instruction_complement': ''
        #                 }                     
         self.start_section_instructions.append(instruction)



    def setMainInstruction(self, program_line):         
         instruction = Instruction()
         instruction.setProgram_line(program_line)
         self.main_section_instructions.append(instruction)
