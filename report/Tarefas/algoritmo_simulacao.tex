...
\begin{algorithm}[ht]
    ...
    \KwEntrada {\textit{programa em formato assembler (linked - exemplo: 000.main.dump)}}

    \BlankLine

    \KwSaida {\textit{arquivo de log de saída do programa simulado (exemplo: 000.main.log)}}

    \BlankLine

    \KwExecutarPrograma{programa}    
    \Begin{
